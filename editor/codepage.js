function codepageGenerator(colors, retina) {
    ...
    function fullBlock(fg) {
        if (!fullBlockBuffer[fg]) {
            fullBlockBuffer[fg] = getData(FULL_BLOCK, colors[fg], new Uint8Array([0, 0, 0, 0]), 9, 16, FONT_80X25, true);
            if (retina) {
                fullBlockBuffer[fg] = doubleScale(fullBlockBuffer[fg], 8);
            }
        }
